...
@endif
  ...
  <?php $sno=1; ?>   
  {!! Form::open(['url'=>'category/delete','id'=>'multipledeleteform']) !!}
...
<div id="myModal3" class="modal fade">
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-danger deletebtn" onclick="location.href='{{ url('category/delete-all') }}'">Delete All</button>
      </div>
    </div>
  </div>
</div>   
